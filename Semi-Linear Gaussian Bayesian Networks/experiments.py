...
from auxiliar import dag_to_cpdag, cpdag_to_networkx, final_metrics, type_distance
...
for graph, data_name, cpdag, types in models_graph:
    for model_label, type_change_value in model_types:
        ...
        for score_metric in model_scores:
            ...
            for n in train_sizes:
                ...
                for seed in seeds:
                    ...
                    if model_label == 'SPBN':
                        ...
                        thd = type_distance(types, node_types)[0]
                        metrics_spbn = final_metrics(skeleton_original, skeleton_learned, thd)
                        ...
                        results_typechange.append({
                            ...
                            "best_ll": best_ll,
                            "ground_ll": ground_ll,
                            "SHD": metrics_spbn["SHD"],
                            "THD": thd,
                            "Recall": metrics_spbn["Recall_total"],
                            "Precision": metrics_spbn["Precision_total"],
                            "node_types": node_types,
                            "edges": final_model.arcs()
                        })
                        ...
                        thd = type_distance(types, node_types)[0]
                        metrics_slgbn = final_metrics(skeleton_original, skeleton_learned, thd)
                        ...
                        results_typechange.append({
                            ...
                            "best_ll": best_ll,
                            "ground_ll": ground_ll,
                            "SHD": metrics_slgbn["SHD"],
                            "THD": thd,
                            "Recall": metrics_slgbn["Recall_total"],
                            "Precision": metrics_slgbn["Precision_total"],
                            "node_types": node_types,
                            "edges": G.edges()
                        })
